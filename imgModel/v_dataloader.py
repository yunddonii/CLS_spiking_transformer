...
from v_config import set_seed_worker
...
def load_data(dataset_dir, T):
    ...
    origin_set.extract_downloaded_files(dataset_dir, dataset_dir)
    origin_set.create_events_np_files(dataset_dir, dataset_dir)
